        ...
        <div className="container mx-auto px-6 py-24 relative z-10">
          <div className="flex flex-col lg:flex-row items-center">
            ...
            >
              ...
              >
                XION <span className="text-white">IOT LORA CORE</span>
              </motion.h1>
              ...
              >
                The development board is a versatile tool for IoT and embedded system projects, featuring a robust DC power jack, an SD card slot for data logging, and the LoRa Ra-02 module for long-range, low-power wireless communication. Powered by a high-performance microcontroller, it ensures efficient processing and smooth operation.
              </motion.p>
              ...
              >
                <h2 className="text-xl font-semibold text-white mb-4">Powering the Module</h2>
                <ul className="space-y-3">
                  {[
                    "Use a USB-C cable to power the board through the USB-C connector.",
                    "The board can also be powered through the DC power jack (9V-12V).",
                    "Ensure that the power source is stable and provides sufficient current."
                  ].map((item, index) => (
