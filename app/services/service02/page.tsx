...
import service02Image from "../../assets/s2.png";
      ...
      <section className="relative py-20 md:py-32 w-full flex items-center justify-center min-h-screen">
        <div className="relative z-10 text-white flex flex-col items-center justify-center px-6 md:px-4 max-w-7xl mx-auto">
          ...
          >
            ...
            >
              Let your idea take form. At ORAGAN, we transform your proof of
              concept into a refined, working prototype you can touch, test, and
              showcase.
            </motion.p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-gray-900/50 border border-gray-700/50 rounded-xl p-8">
              <p className="text-gray-300 text-lg leading-relaxed">
                A prototype is a more advanced, functional version of your idea.
                Unlike a basic Proof of Concept (POC), a prototype demonstrates
                how your product will actually look, feel, and perform. It
                integrates design, user interaction, and technical features into
                a real-world model.
              </p>
              <p className="text-gray-300 text-lg mt-4 leading-relaxed">
                Think of it as your product's first real form—ready for hands-on
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white">
                What We Do in Prototype Development
              </h2>
            </div>
            <div className="bg-gray-900/50 border border-gray-700/50 rounded-xl p-8 mb-8">
              <p className="text-gray-300 text-lg mb-6">
                At ORAGAN, we turn your validated idea or POC into a
                high-quality prototype using cutting-edge tools, engineering
                precision, and thoughtful design. Our multidisciplinary team
            ...
            <div className="bg-blue-900/20 border border-blue-700/50 rounded-xl p-6">
              <p className="text-gray-300 font-medium">
                WE ENSURE YOUR PROTOTYPE REFLECTS YOUR VISION—TECHNICALLY AND
                AESTHETICALLY.
              </p>
            </div>
          </motion.section>
          ...
          >
            ...
            <p className="text-gray-300 text-lg mb-8">
              You're only a prototype away from unlocking funding, launching a
              pilot, or entering the market. Partner with ORAGAN and create the
              version of your idea that moves people.
            </p>
            ...
            <motion.div className="mt-16 relative">
              <div className="relative bg-gray-900/80 backdrop-blur-xl rounded-3xl p-8 border border-gray-700/50 shadow-xl overflow-hidden">
                ...
                <p className="text-gray-400 mb-8">
                  Submit your idea for a free professional review from our
                ...
                <form className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {/* Email Field */}
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-2 ju">
                        Your Email
                      </label>
                      <input
                        type="email"
