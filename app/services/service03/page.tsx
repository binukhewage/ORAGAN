                ...
                <div className="relative z-10 text-white flex flex-col items-center justify-center px-6 md:px-4 max-w-7xl mx-auto">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-300 via-white to-gray-300 mb-6 leading-tight">
                            Design for <span className="text-white">Manufacturing (DFM)</span>
                        </h1>
                        ...
                        >
                            After prototyping, the design is optimized for large-scale production. DFM involves refining the product to be efficiently manufactured, reducing costs, simplifying production processes, and ensuring consistent quality.
                        </motion.p>
                    </motion.div>
                            ...
                            {[
                                {
                                    ...
                                    content: "Redesign components for efficient manufacturing while maintaining functionality and quality."
                                },
                                {
                                    title: "Cost Reduction",
                                    content: "Identify and implement changes that lower production costs without compromising performance."
                                },
                                {
                                    title: "Material Selection",
                                    content: "Choose optimal materials that balance cost, durability, and manufacturing requirements."
                                },
                                {
                                    title: "Assembly Simplification",
                                    content: "Streamline assembly processes to reduce labor time and potential errors in production."
                                }
                            ].map((item, index) => (
                                <motion.div
                                    key={index}
